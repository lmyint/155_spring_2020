...
- Using the code below, construct a visualization of average ratings broken down by minimum age.
...
- Using the code below, construct two alternate visualizations of average ratings broken down by minimum age. These plots use color instead of panels and also only keep games for which the minimum number of players ranges from 1 to 4.
