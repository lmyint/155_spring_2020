...
When we fit regression models in R and display the `summary()` output, the Coefficients table gives two new quantities used in hypothesis testing.
...
a. Fit an *unadjusted* model that ignores these potential confounders. Present a (naïve) answer to the first research question by interpreting the relevant coefficient and conducting an appropriate hypothesis test.
