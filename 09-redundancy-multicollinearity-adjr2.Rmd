...
- Degree 1: Multiple R-squared = `r summary(poly_mod1)$r.squared`. Adjusted R-squared = `r summary(poly_mod1)$adj.r.squared`.
- Degree 2: Multiple R-squared = `r summary(poly_mod2)$r.squared`. Adjusted R-squared = `r summary(poly_mod2)$adj.r.squared`.
- Degree 3: Multiple R-squared = `r summary(poly_mod3)$r.squared`. Adjusted R-squared = `r summary(poly_mod3)$adj.r.squared`.
- Degree 4: Multiple R-squared = `r summary(poly_mod4)$r.squared`. Adjusted R-squared = `r summary(poly_mod4)$adj.r.squared`.
- Degree 5: Multiple R-squared = `r summary(poly_mod5)$r.squared`. Adjusted R-squared = `r summary(poly_mod5)$adj.r.squared`.
