...
- Use and interpret unconditional and conditional proabilities
...
$$ \hbox{p} = \frac{\hbox{odds}}{1+\hbox{odds}} $$
...
c. Repeat part (b) except supoose that the disease is more rare: $P(D = 1) = 1\%$.
