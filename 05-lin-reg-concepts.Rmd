...
ggplot(homes, aes(x = Living.Area, y = Price)) +
    ...
    labs(x = "House price ($)", y = "Living area (square feet)")
```
...
Always start an analysis with visualization! Make a plot that shows the relationship between `Price` and `Living.Area`. Do you think a simple linear regression model is appropriate?
