...
Answer: <span style="background-color: black;">D</span>
...
Answer: <span style="background-color: black;">C</span>
...
Answer: <span style="background-color: black;">A</span>
...
Answer: <span style="background-color: black;">B1 = 0, e^B1 = 1</span>
